...
TARGET = "d381e074fd1ede395f6c21a658f37020661acd78"
PATCH = REPORT / "CLAW-IOS-R3-source-test-ci.patch"
PREFIXES = (".github/workflows/", "Scripts/ci/", "TinodeSDK/", "Tinodios/", "TinodiosDB/",
            "TinodiosUITests/", "Tinodios.xcodeproj/", "TinodeSDKTests/")
EXTRA_TESTS = ('docs/handoff/R3/CI-SMOKE/check_smoke_runner.py', 'docs/handoff/R3/LOCAL-DELETE/check_local_delete_sqlite.py', 'docs/handoff/R3/LOCAL-DELETE-PLAN/reproduce_partial_delete.py')
...
def main():
    ...
    selected = []
    for path in paths:
        allowed = path in ("Podfile", "Podfile.lock") + EXTRA_TESTS or path.startswith(PREFIXES)
